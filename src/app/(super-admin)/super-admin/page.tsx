      ...
      <div className="relative z-10 p-6 space-y-8 max-w-7xl mx-auto">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6 w-full">
          <div className="w-full overflow-x-auto no-scrollbar pb-1">
            <TabsList className="!inline-flex w-max min-w-full justify-start h-16 bg-white/80 dark:bg-slate-950/80 p-1.5 rounded-2xl border border-slate-200/60 dark:border-white/5 shadow-2xl backdrop-blur-xl">
