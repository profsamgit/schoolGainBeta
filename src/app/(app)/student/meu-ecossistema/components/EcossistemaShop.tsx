...
export function EcossistemaShop({
  ...
  return (
    <>
      ...
      <div className={cn(
          "absolute bottom-0 inset-x-0 z-[150] p-0 md:p-6 lg:p-10 flex justify-center transition-all duration-1000 transform",
          ...
          <div className="relative w-full max-w-6xl">
              ...
              <div className="bg-slate-950/95 md:bg-black/40 backdrop-blur-[20px] md:backdrop-blur-[60px] rounded-t-[2.5rem] md:rounded-[3rem] rounded-b-none md:rounded-[3rem] p-1 md:p-2 border-t md:border border-white/10 shadow-[0_50px_100px_rgba(0,0,0,0.8)] flex flex-col gap-2 overflow-hidden">
                  {/* HEADER DA LOJA */}
                  ...
                  {/* CONTEÚDO SCROLLABLE */}
                  <div className="flex flex-col gap-6 md:gap-12 pb-24 md:pb-14 px-4 md:px-10 overflow-y-auto max-h-[75vh] md:max-h-[65vh] scrollbar-hide pt-4 md:pt-6">
                    {[
