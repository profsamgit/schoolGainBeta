...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group peer text-sidebar-foreground duration-200 w-[--sidebar-width] data-[state=collapsed]:w-[--sidebar-width-icon] transition-[width] ease-linear min-h-svh shrink-0 relative"
        data-state={state}
      ...
      >
        <div
          className={cn(
            "duration-200 flex h-full w-[--sidebar-width] transition-[width] ease-linear",
            side === "left"
              ? "left-0"
              : "right-0",
